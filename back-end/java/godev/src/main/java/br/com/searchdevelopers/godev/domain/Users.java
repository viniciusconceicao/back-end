...
public class Users {
    ...
    public Users(Integer idUser, String nameUser, String cpf, String cnpj, LocalDate birthDate, String nameCompany, String email, String password, String role, String phone, String descriptionUser, Double starsUser, Integer ratingsCont, Double ratingsSum, Integer xp, Boolean status, String locality, String photo, LocalDate creationDate, String numberCard, String cvv, String monthCard, String yearCard, Boolean isPremium, Integer ratingNumber, Double numberOfStars, Double starsMedia) {
        this.idUser = idUser;
